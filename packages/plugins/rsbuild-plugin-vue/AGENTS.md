# AI usage (@extenzo/rsbuild-plugin-vue)
...
- When the user project uses **Vue 3** for popup/options etc., in exo.config: `import vue from "@extenzo/rsbuild-plugin-vue"; export default defineConfig({ ..., plugins: [vue()] })`
