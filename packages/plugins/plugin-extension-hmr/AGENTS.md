# AI usage (@extenzo/plugin-extension-hmr)
...
- This plugin only handles “launch browser” and “HMR”; build is done by Rsbuild and plugin-extension-entry/plugin-extension-manifest
