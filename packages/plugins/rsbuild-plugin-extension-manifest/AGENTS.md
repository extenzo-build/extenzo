# AI usage (@extenzo/rsbuild-plugin-extension-manifest)
...
- Removed HTML paths: `dist/background/index.html`, `dist/content/index.html`, etc. (aligned with rsbuild-plugin-extension-entry output)
