...
import "./index.less";
import { IRollConfig } from "app/types/type";
...
import { updateHeaderRules } from "app/util/updateHeaders";
...
export default defineComponent({
  ...
  setup() {
    ...
    const download = (data: any) => {
      ...
      const headers =
        requestHeadersArray?.reduce((acc: Record<string, string>, header: any) => {
    ...
    const showVideo = (data: any) => {
      ...
      setTimeout(() => {
        ...
        // 初始化 Plyr
        plyrInstance.value = new Plyr(playerElement, {
    ...
    return () => (
      <div>
        <div>
          <van-notice-bar
            scrollable={false}
            left-icon={(favIcon.value as string) || "tv-o"}
