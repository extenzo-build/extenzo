import { getUserSecure } from "app/background/secureUser";
import { checkPermission, vPermission } from "app/lib/directive";
  ...
  setup(props) {
    ...
    onMounted(async () => {
      try {
        ...
        user.value = secureUser;
      } catch (error) {
        console.error("Failed to get secure user:", error);
      }
    });
    return () => (
